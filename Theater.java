...
public class Theater {
	...
	public Theater(String theaterName, int totalTickets, String[] movieNames) {
	...
	double bookTicketsAndGetTotalPrice(String movieName, int noOfTickets, String bookedBy) {
		double totalPrice = 0;
